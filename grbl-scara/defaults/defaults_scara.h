...
#define defaults_h
  ...
  #define DEFAULT_X_ACCELERATION 100 // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_Y_ACCELERATION 100 // 10*60*60 mm/min^2 = 10 mm/sec^2
  ...
  #define DEFAULT_SCARA_THETA 45.72 
  #define DEFAULT_SCARA_PSI 92.030 
