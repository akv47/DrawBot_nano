...
#define RC_SERVO_SHORT     13       // Маркер вниз Timer ticks for 0.6ms pulse duration  (9 for 0.6ms)
#define RC_SERVO_LONG      28       // Маркер вверх Timer ticks for 2.5 ms pulse duration  (39 for 2.5ms)     
